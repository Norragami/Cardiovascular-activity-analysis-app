...
dataToSend = Dict("path" => "Мельникова_Елизавета_Дмитриевна_21-04-22_11-43-20_", "startPoint" => 1000, "endPoint" => 100000)
...
Xcoordinate = range(1000,length=length(outputECG),step=1)

plotly()
plot(Xcoordinate,outputECG,layout=(1,1),legend=false)
